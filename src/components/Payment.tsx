...
export default function Payment({ plan = "starter", onSuccess, onError }: Props) {
  const [loading, setLoading] = useState(false);
  const [selected, setSelected] = useState<keyof typeof plans>(plan);
      ...
      <div className="space-y-4">
        <label className="block">
          ...
          <select
            ...
            value={selected}
            onChange={(e) => setSelected(e.target.value as keyof typeof plans)}
          >
